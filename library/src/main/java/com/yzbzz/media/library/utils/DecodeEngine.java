...
public class DecodeEngine {
    ...
    public boolean convertMusicFileToWaveFile(String musicFileUrl, String decodeFileUrl) {
        ...
        return decodeMusicFile(musicFileUrl, decodeFileUrl, true, -1, -1);
    }
    ...
    public boolean convertMusicFileToWaveFile(String musicFileUrl, String decodeFileUrl,
        ...
        return decodeMusicFile(musicFileUrl, decodeFileUrl, true, (long) startSecond * 1000000,
                (long) endSecond * 1000000);
    }
    ...
    public boolean convertMusicFileToPcmFile(String musicFileUrl, String decodeFileUrl) {
        ...
        return decodeMusicFile(musicFileUrl, decodeFileUrl, false, -1, -1);
    }
    ...
    public boolean convertMusicFileToPcmFile(String musicFileUrl, String decodeFileUrl,
        ...
        return decodeMusicFile(musicFileUrl, decodeFileUrl, false, (long) startSecond * 1000000,
                (long) endSecond * 1000000);
    }
     ...
     * @param endMicroseconds   结束时间 微秒
     */
    private boolean decodeMusicFile(String musicFileUrl, String decodeFileUrl, boolean isWave, long startMicroseconds, long endMicroseconds) {
